  ...
  return (
    <SafeAreaView style={style.screen}>
      <View style={style.container}>
        ...
        <Button onPress={getRandomColor} title="Pick Color" />
        <Button onPress={()=> handlePress(hexcolor)}  width={50} title="Save" />
        <View style={{backgroundColor:hexcolor, height:50, width:50, justifyContent:"center", alignSelf:"center", marginTop: 30}}/>
      </View>
    </SafeAreaView>
  );
}
